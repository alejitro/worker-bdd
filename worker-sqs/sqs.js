...
var bddService = require('../app/services/bdd.srv.js');

AWS.config.update({region:'us-east-1'});
var sqs = new AWS.SQS({apiVersion: '2012-11-05'});
const sqsUrl = 'https://sqs.us-east-1.amazonaws.com/669213563582/worker-calabash-queue.fifo'; // CAMBIAR POR URL SQS DE ACUERDO A TIPO DE PRUEBA
...
module.exports.getSqs = function(req,success,error){
  ...
  executeService = (req, success,error)=>{
    bddService.generate(req, function(apps){ //LLAMAR AL SERVICIO QUE SE EJECUTABA DESDE EL CONTROLADOR VALIDAR PARAMETROS
        success({ status: "OK" });
    },function(err){
        error(err);
